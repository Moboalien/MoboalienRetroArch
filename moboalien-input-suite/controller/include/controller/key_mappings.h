...
// String to key code mapping for convenience
inline std::unordered_map<std::string, int> getKeyMap() {
    ...
    keyMap["Y"] = VK_Y; keyMap["Z"] = VK_Z; keyMap["0"] = VK_0; keyMap["1"] = VK_1;
    keyMap["2"] = VK_2; keyMap["3"] = VK_3; keyMap["4"] = VK_4; keyMap["5"] = VK_5;
    keyMap["6"] = VK_6; keyMap["7"] = VK_7; keyMap["8"] = VK_8; keyMap["9"] = VK_9;
    keyMap["SPACE"] = VK_SPACE; keyMap["ENTER"] = VK_RETURN;
    keyMap["SHIFT"] = VK_SHIFT; keyMap["CTRL"] = VK_CONTROL;
    return keyMap;
}